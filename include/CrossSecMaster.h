...
public:
	...
	virtual double c_sec(double a_s, double a_Q2, double a_t,double a_weight, double a_phi, double a_th,double a_sc_D,double e_g,double fit_scale,double tSlope){return 0;};
